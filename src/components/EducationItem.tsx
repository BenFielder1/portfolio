    ...
    return (
        <div className="relative pl-8 pb-12 group">
            ...
            <div className="glass-card p-6 ml-4">
                ...
                {/* Grade badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-[var(--accent-cyan)]/20 to-[var(--accent-purple)]/20 border border-[var(--accent-cyan)]/30 mb-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {courses.map((course) => (
                                ...
                                >
                                    <svg className="w-4 h-4 text-[var(--accent-cyan)] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
